...
class GUI:
    ...
    def layout(self,name):
        ...
        self.entrylabel = Label(self.labelBottom,
                              ...
                              state = DISABLED,
                              cursor="xterm")
        self.last1string=StringVar()
        self.last2string=StringVar()
        self.last3string=StringVar()
        self.last1string.set('')
        self.last2string.set('')
        self.last3string.set('')
    ...
    def sendMessage(self):
        last1=self.last1string.get()
        last2=self.last2string.get()
        last3=self.last3string.get()
        self.textCons.config(state=DISABLED)
        self.Window.focus()
        ...
        while True:
            ...
            if last3=="":
                if last2=="":
                    if last1=="":
                        print('here1')
                        l=chat.init(mes,last1,last2,last3).split('\\\\\\')
                        self.last1string.set(l[0])
                        if self.resp==None:
                            self.resp = l[1]
                        else:
                            self.resp=self.resp
